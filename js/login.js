...
async function login() {
    ...
    const res = await fetch("https://gddq60js-3000.inc1.devtunnels.ms/auth/login", {
        method: "POST",
...
async function signup() {
    ...
    const res = await fetch("https://gddq60js-3000.inc1.devtunnels.ms/auth/signup", {  // Updated URL
        method: "POST",
        headers: { "Content-Type": "application/json" },
